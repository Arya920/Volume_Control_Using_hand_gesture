...
while True:
    ...
    if results.multi_hand_landmarks:
        for handLms in results.multi_hand_landmarks:
            ...
            if distance < VOLUME_THRESHOLD:
                cv2.putText(img, f"Distance:{round(distance,2)}<65, Volume Decreasing", (10, 30), cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (0, 0, 0), 2)
            else:
                cv2.putText(img, f"Distance:{round(distance,2)}>65, Volume Increasing", (10, 30), cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (255,0, 0), 2)
